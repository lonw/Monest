...
$result = mysql_query("SELECT * FROM categories WHERE parent = 0 and lang = 0");
$errors = array();
$category = '';
$post_parent = '';
...
<div class="row">
  ...
  <div class="col-md-6">
    <table class="table table-bordered ">
        ...
        <tbody>
          <?php
          $sql="SELECT * FROM categories WHERE parent = 0 and lang = 0"; //get accsss to the parents
          $result = mysql_query($sql);
           while($parent = mysql_fetch_assoc($result)):
             $parent_id = (int)$parent['id'];
             $sql2 = "SELECT * FROM categories WHERE parent = '$parent_id' and lang = 0";
