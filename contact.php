  ...
  <div class="content">
    <div class='row wrap'>
      ...
      <div class="col-md-12" align="center">
				<br>
				<h2 style="color:grey;">&nbsp;联系我们 - CONTACTS</h2><hr>
          <?php include 'googlemap.php' ?>

          <div class="container" align="left" style="background-color:white;color:black;">

           <div class="col-md-4">
             <h3 class="bg-success">联系资料 - CONTACT INFO</h3>
             <h4 style="text-decoration: underline;">加拿大多伦多 华旗金融总部</h4>
             ...
             <h4 style="text-decoration: underline;">加拿大 华旗金融办事处</h4>
             <p>
               华旗金融办事处遍布 <b>多伦多</b>、 <b>渥太华</b>、 <b>密西沙加</b>、 <b>滑铁卢</b>、 <b>埃德蒙顿</b>。<br>
             </p>
             <a href="map.php" class="btn btn-success btn-xs">
               详细地址
             </a>
             <br>
             <h4 style="text-decoration: underline;">中国 华旗金融办事处</h4>
             <p>
               华旗金融办事处遍布中国北京、中国上海。
             </p>
             <a href="map.php" class="btn btn-success btn-xs">
            ...
            <br>
             <h3 id="hireme" class="bg-success">招聘职位 - JOB CENTER</h3>
             <?php  $data = mysql_fetch_array($query); ?>
             <?php echo $data['position']; ?>

           </div>
           <div class="col-md-8">
             <h2>联系表格 - CONTACT FORM</h2><br>
