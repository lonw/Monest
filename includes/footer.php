...
<div class="color-content" style="color:white;">
    <div class="container" style="text-align:center;">
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
        <h5 class="pull-left">咨询相关内容?<span style="color: #ffffff;"> 欢迎向我们致电</span></h5>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-4"><h5>+1 416-855-4565</h5></div>
      <div class="col-lg-4 col-md-4 col-sm-4">
        <h5 class="pull-right lead">整周营业<span style="color: #ffffff;">从 <strong>9:00</strong> am 至 <strong>5:50</strong> pm</span></h5>
      </div>
    </div>
      </div>
...
<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
<div id="text-6"><h4>地址 </h4> <div class="textwidget"><address class="address-2">
...
<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
<div id="text-10"><h4>技术支援</h4> <div> <ul>
<li><a href="#">表格下载</a></li>
<li><a href="members.php">预约会议</a></li>
<li><a href="contact.php">技术困难</a></li>
<li><a href="admin/">后台管理</a></li>
</ul></div>
</div> </div>
<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
<div id="text-11"><h4>关于我们</h4> <div><ul>
<li><a href="profile.php">公司简介</a></li>
<li><a href="members.php">核心团队</a></li>
<li><a href="team.php">组织架构</a></li>
<li><a href="honor.php">华旗荣誉</a></li>
</ul></div>
</div> </div>
