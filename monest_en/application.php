<?php
  ...
  $termtype= ((isset($_POST['termtype']) && $_POST['termtype'] != '')?sanitize($_POST['termtype']):'');
      ...
      $insertSql = "INSERT INTO loan(`type`, `name`, `sin`, `gender`, `ms`, `bd`, `phone`, `email`, `address`, `paddress`,`cemployer`, `pemployer`,
...
<script type="text/javascript">
  window.open("https://www.secureapp.com/centum/app/CBasexMtgApp1.asp?firmcode=SWMZ&expertUserCode=TONGT&brokername=CENTUM%20Monest%20Mortgage%20Inc");
</script>
